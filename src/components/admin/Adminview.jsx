...
import { IoAccessibility,IoPodium,IoSettings,IoHome,IoSync,IoWarning,IoPower,IoPeople} from "react-icons/io5";
...
export default function Adminview() {
  ...
  useEffect(() => {
    if (activeSection === 'usuarios') {
      fetchUsers();
    } else if (activeSection === 'transacciones') {
      fetchTransactions();
  ...
  const filteredReports = reports.filter(report =>
    report.type.toLowerCase().includes(reportSearchTerm.toLowerCase()) ||
    report.id.toString().includes(reportSearchTerm)
  );
  ...
  const renderSection = () => {
    ...
    <div className="section">
      ...
      <div className="search-container">
        <label htmlFor="userSearch">Buscador</label>
          <input
            id="userSearch"
            type="text"
  ...
  return (
    <div className="section">
      ...
      <div className="content-box">
        <div className="search-container">
          <label htmlFor="transactionSearch">Buscador</label>
          <input
  ...
  case 'reportes':
    return (
      <div className="section">
        ...
        <div className="content-box"> 
          <div className="search-container">
            <label htmlFor="reportSearch">Buscador por ID</label>
            <input
              id="reportSearch"
              type="text"
          ...
          {!editingReport && reportSearchTerm && (
            <>
              <div className="user-list-header4">
                <span>ID</span>
                <span>Tipo</span>
                <span>Fecha</span>
                <span>Respuesta</span>
              ...
              <ul className="user-list">
                {filteredReports.length > 0 ? ( 
                  ...
                  <li>No se encontraron reportes</li>
                )}
              </ul>
            </>
          )}
    ...
    return (
      <div className="section">
        ...
        {searchTerm && !editingUser && (
          <>
            <div className="user-list-header2">
              <span>ID</span>
              <span>Nombre</span>
              <span>Tipo</span>
              <span>Fecha</span>
